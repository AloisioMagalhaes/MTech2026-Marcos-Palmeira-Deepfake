...
('ARTEFATO DIGITAL','O conteúdo analisado',['Reconstituição esquemática baseada na reportagem: vídeo com imagem prévia do ator + voz sintética + oferta comercial.','A reportagem da CNN Brasil é a evidência disponível; o arquivo original do anúncio não foi recuperado.','Não é possível afirmar hash, metadados, autoria ou perícia quadro a quadro.'],'template-icones-ilustracoes-008.png'),
('GUIA DE RECONHECIMENTO','Jogo de erros do artefato',['Sinal 1: fala e imagem podem ter sido combinadas a partir de material anterior.','Sinal 2: oferta comercial e suposto endosso exigem confirmação independente.','Limite: sem arquivo original, não há perícia técnica quadro a quadro.'],'template-icones-ilustracoes-026.png'),
...
('GUIA DE CONVIVÊNCIA','Como reduzir danos',['Não clicar, pagar ou fornecer dados antes de confirmar a origem.','Preservar URL e denunciar o anúncio sem expor pessoas ou vítimas.','Separar crítica ao conteúdo de acusação sem evidência.'],'template-icones-ilustracoes-040.png'),
...
('CAMPANHA · 1','Público, linguagem e organização',['Público: estudantes, famílias e comunidade escolar.','Linguagem: direta, não sensacionalista, visual e acessível.','Organização: pesquisa, análise e comunicação revisam fontes, evidências e créditos.'],'template-icones-ilustracoes-100.png'),
('CAMPANHA · 2','Explicação técnica simplificada',['Deepfake é conteúdo audiovisual alterado ou criado com IA para parecer que uma pessoa disse ou fez algo.','No caso, a aparência de fala foi associada a uma oferta comercial que o ator declarou não ter autorizado.'],'template-icones-ilustracoes-007.png'),
...
('CONCLUSÃO','Aprendizados principais',['Fato, evidência, inferência e hipótese precisam ser separados.','Imagem e voz podem ser reutilizadas para fabricar autoridade.','A resposta mais segura é confirmação independente antes de compartilhar ou pagar.'],'template-icones-ilustracoes-007.png'),
...
for i,(k,t,ps,img) in enumerate(S,1):
 ...
 for n,p in enumerate(ps,1):
  ...
  y+=h+18
 diagram(d,i)
 if img.startswith('template-'): d.text((110,790),'ILUSTRAÇÃO DO TEMPLATE · APOIO VISUAL, NÃO EVIDÊNCIA DO CASO',font=font(13,1),fill=(16,42,67))
