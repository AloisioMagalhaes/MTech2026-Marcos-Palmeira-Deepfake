...
('PROBLEMA DIGITAL','Qual é o problema?',['Publicidade digital pode simular o endosso de uma pessoa real usando IA.','O caso circulou no Instagram e promovia um kit de ferramentas.','Relevância: imagem, voz, confiança e possível pagamento são envolvidos.'],'template-icones-ilustracoes-106.png'),
...
('CAMPANHA · 2','Explicação técnica simplificada',['Deepfake é conteúdo audiovisual alterado ou criado com IA para parecer que uma pessoa disse ou fez algo.','No caso, a aparência de fala foi associada a uma oferta comercial que o ator declarou não ter autorizado.'],'template-icones-ilustracoes-008.png'),
