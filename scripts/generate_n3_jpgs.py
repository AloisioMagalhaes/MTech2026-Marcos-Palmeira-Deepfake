...
('CONCLUSÃO','Aprendizados principais',['Fato, evidência, inferência e hipótese precisam ser separados.','Imagem e voz podem ser reutilizadas para fabricar autoridade.','A resposta mais segura é confirmação independente antes de compartilhar ou pagar.'],'template-icones-ilustracoes-075.png'),
